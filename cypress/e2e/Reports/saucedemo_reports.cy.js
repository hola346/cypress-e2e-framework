import home_sauce_page, { typePassword, typeUsername } from "../saucedemo/home_sauce_page";
import Inventory_page_saucedemo from "..//saucedemo//Inventory_page_saucedemo";  //importing classes previously defined
...
describe('POM implementation', ()=>{
    ...
    it('Login', ()=>{
        ...
        it('Wrong Verification', ()=>{
        home_sauce_page.typeUsername(username); // These 3 are methods within classes
        home_sauce_page.typePassword(password);
        home_sauce_page.PressLoginButton();
        Inventory_page_saucedemo.elements.TitleSpan().should('have.text','Product'); // This is a variable - 'elements'
        cy.url().should('contains', 'inventory')
    });
